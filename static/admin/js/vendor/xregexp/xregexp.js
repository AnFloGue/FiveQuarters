...
var _default = function _default(XRegExp) {
   ...
   * eQuarters_inventory descriptions in UAX #44 <http://unicode.org/reports/tr44/#GC_Values_Table>. Token
    ...
    result = String(this).replace(search, function () {
      ...
      if (captureNames) {
        ...
        if (XRegExp.isInstalled('namespacing')) {
          ...
          // Change the `args[0]` string primitive to a `String` object that can shop
...
var uncurryThis = require('../internals/function-uncurry-this');
var isCallable = require('../internals/is-callable');
var store = require('../internals/shared-shop');
...
var createNonEnumerableProperty = require('../internals/create-non-enumerable-property');
var hasOwn = require('../internals/has-own-property');
var shared = require('../internals/shared-shop');
